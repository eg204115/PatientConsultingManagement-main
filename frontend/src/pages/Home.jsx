    ...
    <>
            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                <p className='text__para'>
                  ...
                  (AHA), hospitals are licensed institutions with 
                  at least six beds whose primary function is to 
                  provide diagnostic and therapeutic patient 
                  services for medical conditions; they have an 
                  organized physician staff; and they provide 
                  continuous nursing services under the .
                </p>
      ...
      <section>
        <div className="container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] 
          lg:mt-[55px]">
          ...
          <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0"> 
            ...
            <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
              ...
              <div className="flex items-center gap-[6px] lg:gap-3">
                ...
                <p className='text-[10px] leading-[10px] lg:text-[14px] lg:leading-
                5 text-textColor font-[400]'>
                  10:00AM
                </p>
              </div>
                <span className='w-5 h-5 lg:w-[34px] lg:h-[34px] flex items-center 
                justify-center bg-yellowColor rounded py-1 px-[6px] lg:py-3 lg:px-
                [9px]'>
              ...
              <div className='flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]'>
                ...
                text-headingColor'>Nimal Rathnasiri</h4>
              </div>
                </div>
              </div>
            </div>
